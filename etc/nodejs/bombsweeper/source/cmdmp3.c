...
//   gcc -o cmdmp3.exe -lwinmm cmdmp3.c c:/windows/system32/winmm.dll
...
int main(int argc,char **argv) {
  int volume = 1000; //max volume is 1000
  ...
  sprintf(cmdBuff,"setaudio theMP3 volume to %d Wait",volume);
  sendCommand(cmdBuff);
