...
const {dual} = require("./topo_operators.js");
const {sqrt} = Math;
...
function unitSphere(poly){
  // todo: fixme: breaks face orientation on, e.g UHT and UdtdtdtdtdtdtT

  poly.vertices = poly.vertices.map(e=>unit(e));
  return new polyhedron(poly.vertices, poly.faces, poly.name);
}
