...
function Assembler(){
  ...
  this.run = function(data) {
    ...
    for(this.i = 0;this.i < this.s.length;this.i++){
      ...
      this.f = instructionDictionary1[c[0].toLowerCase()/*a.substr(0,3)*/];
...
Assembler.differentiateNumberLength = function(value){
  ...
  if(value.length > 2){
    if(value.length == 3){value = "0"+value;}
    value = value.slice(0,2)+" "+value.slice(2,Number.MAX_VALUE);
  }
...
instructionDictionary1['draw'] = instructionDictionary1['dis'] = function(s)
{return "20";}

instructionDictionary1['return'] = instructionDictionary1['ret'] = instructionDictionary1['rts'] = function(s)
{return "21";}

instructionDictionary1['call'] = instructionDictionary1['cll'] = instructionDictionary1['jsr'] = function(s)
{
  if(s.charAt(0) != '%'){print("line "+this.i+':'+"expected % but found "+s);return "";}
  return Assembler.differentiateInstructionLength(undefined,'11',compileNumber(s.slice(1)));
}

instructionDictionary1['print'] = instructionDictionary1['shw'] = function(s)
{
  if(s.charAt(0) != '%'){print("line "+this.i+':'+"expected % but found "+s);return "";}
...
instructionDictionary1['rsh'] = instructionDictionary1['shr'] = function(data)
{return Assembler.assembleMathInstruction(data,6<<4);}

instructionDictionary1['lsh'] = instructionDictionary1['shl'] = function(data)
